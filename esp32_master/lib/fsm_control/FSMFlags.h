...
/**
 * FSMFlags - Commandes WiFi pour controle à distance de la FSM
 * 
 * Contient 3 flags volatiles avec accès thread-safe via mutex:
...
public:
    ...
    // === SETTERS (pour WiFiProtocol callbacks) ===
