/**
 * PROGRAMME DE CALIBRATION - ENCODEURS
 * 
 * Ce programme aide à trouver la VRAIE résolution de vos encodeurs
 * et à calibrer les paramètres du robot
 */
...
void setup() {
    Serial.begin(9600);
    while (!Serial) { delay(10); } // Attendre que Serial soit prêt
    
    Serial.println("\n\n=========================================");
    Serial.println("  CALIBRATION ENCODEURS - EUROBOT 2026");
    Serial.println("=========================================\n");
